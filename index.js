...
function gameOver()
{
    ...
    const gameOverMessage = `Woof! Game Over! Final Score - <span class = 'badge'>${score}</span> Click 'Play Game' button to play again`
...
function outputChoiceFeedBack(hit)
{
    if(hit)
    {
        updateStatusElement(currentGameStatusElem, "block", winColor, "Woof Woof!! :)")
    }
    else
    {
        updateStatusElement(currentGameStatusElem, "block", loseColor, "Woof.. :(")
    }
}
...
function checkForIncompleteGame()
{
    ...
    if(serializedGameObj)
    {
        ...
        {
            if(confirm('Would you like to continue with your last woof?'))
            {
                score = gameObj.score
...
function shuffleCards()
{
    ...
    function shuffle()
    {
        ...
        if(shuffleCount == 500)
        {
            ...
            dealCards()
            updateStatusElement(currentGameStatusElem, "block", primaryColor, "Please click the card that you think is the Nikita of Spades...")
